...
Pushes to `main` publish `site/` to GitHub Pages through the [deploy workflow](.github/workflows/deploy.yml). The repo's Pages source must be set to "GitHub Actions" once, under Settings → Pages.
